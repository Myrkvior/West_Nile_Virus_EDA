...
let
    ...
    #"Replaced Value2" = Table.ReplaceValue(#"Replaced Value1","Acute flaccid paralysis†","Neuroinvasive-acute flaccid paralysis",Replacer.ReplaceText,{"Characteristic"}),
...
let
    Source = Web.Page(Web.Contents("https://www.cdc.gov/mmwr/preview/mmwrhtml/mm6030a1.htm")),
    Data1 = Source{1}[Data],
    #"Changed Type" = Table.TransformColumnTypes(Data1,{{"Header", type text}, {"State†", type text}, {"WNV No.", type text}, {"WNV Rate", type text}, {"CALV No.", type text}, {"CALV Rate", type text}, {"EEEV No.", type text}, {"EEEV Rate", type text}, {"SLEV No.", type text}, {"SLEV Rate", type text}, {"POWV No.", type text}, {"POWV Rate", type text}}),
    ...
    #"Renamed Columns" = Table.RenameColumns(#"Removed Top Rows",{{"State†", "State"}}),
...
let
    ...
    #"Replaced Value" = Table.ReplaceValue(#"Filtered Rows","18–59","18-59",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value1" = Table.ReplaceValue(#"Replaced Value","January–March","January-March",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value2" = Table.ReplaceValue(#"Replaced Value1","April–June","April-June",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value3" = Table.ReplaceValue(#"Replaced Value2","July–September","July-September",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value4" = Table.ReplaceValue(#"Replaced Value3","October–December","October-December",Replacer.ReplaceText,{"Characteristic"}),
...
let
    Source = Web.Page(Web.Contents("https://www.cdc.gov/mmwr/preview/mmwrhtml/mm6127a3.htm")),
    Data2 = Source{2}[Data],
    #"Changed Type" = Table.TransformColumnTypes(Data2,{{"Header", type text}, {"U.S. Census division/State†", type text}, {"Virus West Nile No.", type text}, {"Virus West Nile Rate", type text}, {"Virus La Crosse No.", type text}, {"Virus La Crosse Rate", type text}, {"Virus Powassan No.", type text}, {"Virus Powassan Rate", type text}, {"Virus St. Louis encephalitis No.", type text}, {"Virus St. Louis encephalitis Rate", type text}, {"Virus Eastern equine encephalitis No.", type text}, {"Virus Eastern equine encephalitis Rate", type text}, {"Virus Jamestown Canyon No.", type text}, {"Virus Jamestown Canyon Rate", type text}})
in
    #"Changed Type"
```
...
let
    ...
    #"Removed Top Rows" = Table.Skip(#"Removed Columns",3),
    #"Renamed Columns" = Table.RenameColumns(#"Removed Top Rows",{{"U.S. Census division/State†", "State"}, {"Virus West Nile No.", "WNNV Total Cases"}, {"Virus West Nile Rate", "WNNV Rate"}}),
    #"Added Custom" = Table.AddColumn(#"Renamed Columns", "Year", each 2011),
    #"Replaced Value" = Table.ReplaceValue(#"Added Custom","—","0",Replacer.ReplaceText,{"WNNV Total Cases", "WNNV Rate"}),
    ...
    #"Replaced Value1" = Table.ReplaceValue(#"Filtered Rows","Missouri§","Missouri",Replacer.ReplaceText,{"State"})
in
    #"Replaced Value1"
```
</details> 
...
let
    ...
    #"Replaced Value" = Table.ReplaceValue(#"Changed Type1","18–59","18-59",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value1" = Table.ReplaceValue(#"Replaced Value","January–March","January-March",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value2" = Table.ReplaceValue(#"Replaced Value1","April–June","April-June",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value3" = Table.ReplaceValue(#"Replaced Value2","July–September","July-September",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value4" = Table.ReplaceValue(#"Replaced Value3","October–December","October-December",Replacer.ReplaceText,{"Characteristic"}),
...
let
    ...
    #"Replaced Value" = Table.ReplaceValue(#"Renamed Columns","—",0,Replacer.ReplaceValue,{"State", "WNNV Total Cases", "WNNV Rate", "Year"}),
...
let
    ...
    #"Replaced Value" = Table.ReplaceValue(#"Filtered Rows","119§","119",Replacer.ReplaceText,{"WNV Total Cases"}),
    #"Replaced Value1" = Table.ReplaceValue(#"Replaced Value","18–59","18-59",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value2" = Table.ReplaceValue(#"Replaced Value1","January–March","January-March",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value3" = Table.ReplaceValue(#"Replaced Value2","April–June","April-June",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value4" = Table.ReplaceValue(#"Replaced Value3","July–September","July-September",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value5" = Table.ReplaceValue(#"Replaced Value4","October–December","October-December",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value6" = Table.ReplaceValue(#"Replaced Value5","Encephalitis","Neuroinvasive-encephalitis",Replacer.ReplaceText,{"Characteristic"}),
    ...
    #"Replaced Value8" = Table.ReplaceValue(#"Replaced Value7","Acute flaccid paralysis†","Neuroinvasive-acute flaccid paralysis",Replacer.ReplaceText,{"Characteristic"}),
...
let
    ...
    #"Added Custom" = Table.AddColumn(#"Removed Columns", "Year", each 2013),
    #"Removed Top Rows" = Table.Skip(#"Added Custom",3),
    #"Replaced Value" = Table.ReplaceValue(#"Removed Top Rows","—",0,Replacer.ReplaceValue,{"State", "WNNV Total Cases", "WNNV Rate", "Year"}),
...
let
    ...
    #"Replaced Value" = Table.ReplaceValue(#"Removed Errors","18–59","18-59",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value1" = Table.ReplaceValue(#"Replaced Value","January‒March","January-March",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value2" = Table.ReplaceValue(#"Replaced Value1","April‒June","April-June",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value3" = Table.ReplaceValue(#"Replaced Value2","July‒September","July-September",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value4" = Table.ReplaceValue(#"Replaced Value3","October‒December","October-December",Replacer.ReplaceText,{"Characteristic"}),
...
let
    ...
    #"Replaced Value" = Table.ReplaceValue(#"Renamed Columns","—","0",Replacer.ReplaceText,{"WNNV Total Cases", "WNNV Rate"}),
...
let
    ...
    #"Replaced Value" = Table.ReplaceValue(#"Added Custom","—","0",Replacer.ReplaceText,{"Virus type West Nile No.", "Virus type West Nile Rate"}),
...
let
    ...
    #"Replaced Value" = Table.ReplaceValue(#"Added Custom","—","0",Replacer.ReplaceText,{"Virus, no. (rate) West Nile.1"}),
...
let
    ...
    Data0 = Source{0}[Data],
    #"Changed Type" = Table.TransformColumnTypes(Data0,{{"Characteristic", type text}, {"Virus type, no. (%)† West Nile #(lf)(n = 971)", type text}, {"Virus type, no. (%)† La Crosse #(lf)(n = 55)", type text}, {"Virus type, no. (%)† Jamestown Canyon #(lf)(n = 45)", type text}, {"Virus type, no. (%)† Powassan #(lf)(n = 43)", type text}, {"Virus type, no. (%)† Eastern equine encephalitis #(lf)(n = 38)", type text}, {"Virus type, no. (%)† St. Louis encephalitis #(lf)(n = 17)", type text}}),
    #"Removed Columns" = Table.RemoveColumns(#"Changed Type",{"Virus type, no. (%)† La Crosse #(lf)(n = 55)", "Virus type, no. (%)† Jamestown Canyon #(lf)(n = 45)", "Virus type, no. (%)† Powassan #(lf)(n = 43)", "Virus type, no. (%)† Eastern equine encephalitis #(lf)(n = 38)", "Virus type, no. (%)† St. Louis encephalitis #(lf)(n = 17)"}),
    #"Split Column by Delimiter" = Table.SplitColumn(#"Removed Columns", "Virus type, no. (%)† West Nile #(lf)(n = 971)", Splitter.SplitTextByEachDelimiter({" "}, QuoteStyle.Csv, true), {"Virus type, no. (%)† West Nile #(lf)(n = 971).1", "Virus type, no. (%)† West Nile #(lf)(n = 971).2"}),
    #"Changed Type1" = Table.TransformColumnTypes(#"Split Column by Delimiter",{{"Virus type, no. (%)† West Nile #(lf)(n = 971).1", type text}, {"Virus type, no. (%)† West Nile #(lf)(n = 971).2", type text}}),
    #"Added Custom" = Table.AddColumn(#"Changed Type1", "Year", each 2019),
    #"Removed Top Rows" = Table.Skip(#"Added Custom",1),
    #"Renamed Columns" = Table.RenameColumns(#"Removed Top Rows",{{"Virus type, no. (%)† West Nile #(lf)(n = 971).1", "WNV Total Cases"}, {"Virus type, no. (%)† West Nile #(lf)(n = 971).2", "WNV Case %"}}),
    #"Changed Type2" = Table.TransformColumnTypes(#"Renamed Columns",{{"Year", Int64.Type}, {"WNV Total Cases", Int64.Type}}),
    #"Removed Errors" = Table.RemoveRowsWithErrors(#"Changed Type2", {"WNV Total Cases", "Characteristic", "WNV Case %", "Year"}),
    #"Replaced Value" = Table.ReplaceValue(#"Removed Errors","18–59","18-59",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value1" = Table.ReplaceValue(#"Replaced Value","Jan–Mar","January-March",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value2" = Table.ReplaceValue(#"Replaced Value1","Apr–Jun","April-June",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value3" = Table.ReplaceValue(#"Replaced Value2","Jul–Sep","July-September",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value4" = Table.ReplaceValue(#"Replaced Value3","Oct–Dec","October-December",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value5" = Table.ReplaceValue(#"Replaced Value4","Encephalitis","Neuroinvasive-encephalitis",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value6" = Table.ReplaceValue(#"Replaced Value5","Meningitis","Neuroinvasive-meningitis",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value7" = Table.ReplaceValue(#"Replaced Value6","AFP","Neuroinvasive-acute flaccid paralysis",Replacer.ReplaceText,{"Characteristic"}),
    #"Replaced Value8" = Table.ReplaceValue(#"Replaced Value7","Unspecified","Neuroinvasive-unspecified",Replacer.ReplaceText,{"Characteristic"})
...
let
    ...
    #"Replaced Value2" = Table.ReplaceValue(#"Replaced Value1","—","0",Replacer.ReplaceText,{"Virus type, no. (rate*) West Nile.1"}),
...
let
    ...
    #"Replaced Value" = Table.ReplaceValue(#"Added Custom","—","0",Replacer.ReplaceText,{"Cases, by virus type, no. (rate)* West Nile.1"}),
...
1. McDonald E, Mathis S, Martin SW, Staples JE, Fischer M, Lindsey NP. Surveillance for West Nile virus disease — United States, 2009–2018.
